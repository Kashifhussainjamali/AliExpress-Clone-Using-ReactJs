...
function Card9(){
    ...
    <div className={style["main1"]}>
        ...
        <img src="img11.webp" alt="" className={style["img"]}/>
        <p className={style["text1"]}>Charging Cabl...</p>
        <small className={style["text1"]}>⭐⭐⭐ 1,000+Sold</small><br />
        <b className={style["text2"]}>PKR</b>
        <b className={style["text3"]}>1,572</b>
        <s className={style["text4"]}>PKR1,957</s><br/>
        <p className={style["lasttext"]}><b className={style["btn11"]}>Wellcome Deal</b>🔴<b className={style["btn11"]}>Sale</b>🔴 -67%</p>

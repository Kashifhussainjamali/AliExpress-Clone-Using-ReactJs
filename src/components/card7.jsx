...
function Card7(){
    ...
    <div className={style["main1"]}>
        ...
        <img src="img9.webp" alt="" className={style["img"]}/>
        <p className={style["text1"]}>Silver watch...</p>
        <small className={style["text1"]}>⭐⭐⭐ 1,000+Sold</small><br />
        <b className={style["text2"]}>PKR</b>
        <b className={style["text3"]}>2,576</b>
        <s className={style["text4"]}>PKR4,977</s><br/>
        <p className={style["lasttext"]}><b className={style["btn11"]}>Wellcome Deal</b>🔴<b className={style["btn11"]}>Sale</b>🔴 -87%</p>
